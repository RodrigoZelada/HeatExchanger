...
Line(12) = {4, 8};
//+
Circle(13) = {0.5, 0, 0.5, 0.25, 0, 2*Pi};
//+
Circle(14) = {0.5, 1, 0.5, 0.25, 0, 2*Pi};
//+
Circle(15) = {0.5, 0.5, 0, 0.25, 0, 2*Pi};
//+
Circle(16) = {0.5, 0.5, 1, 0.25, 0, 2*Pi};
//+
...
Plane Surface(10) = {14};
//+
Surface Loop(1) = {5, 6, 9, 8, 7, 10, 2, 4, 3, 1};
//+
Volume(1) = {1};
